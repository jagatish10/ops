...
<table class="table table-striped table-bordered table-hover">
									<thead>
										<tr bgcolor="#00ccff"><td colspan=5 style="font-weight:bold" align=center>Waiting for Payment Order</td></tr>
...
<tr align=center><td><?php echo $row[0];?></td><td><?php echo $row[2];?></td><td>Waiting for Payment</td><td><?php echo $row[12];?></td>
...
<td><input type="submit" name="submit" value="PRINT" formaction="status.php"/></td></form></tr>
<?php endwhile;?>
