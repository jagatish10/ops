...
<body>
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        ...
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                          ...
                          <li><a href="../admin/finished.php" class="menu-top-active">Finished</a></li>
                       </ul>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header">LIST OF FINISHED ORDERS</h4>
                ...
                <table data-vertable="ver1">
                  ...
                  <thead>
                    <tr class="row100 head">
                      ...
                      <th class="column100 column5"  data-column="column5">COLLECTION</th>
                  ...
                  <tbody>
                    <tr class="row100">
                      ...
                      <td class="column100 column3" data-column="column3">Finished</td>
                      <td class="column100 column4" data-column="column4"><input type="hidden" name="Payment" value="<?php echo $row[12];?>"><?php echo $row[12];?></td>
                      <td class="column100 column5" data-column="column5"><input type="hidden" name="Collection" value="<?php echo $row[10];?>"><?php echo $row[10];?></td>
                      <td class="column100 column6" data-column="column6"><input type="hidden" name="Address" value="<?php echo $row[13];?>"><?php echo $row[13];?></td>
