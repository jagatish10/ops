...
<body>
    ...
    <div class="content-wrapper">
        ...
        <div class="row pad-botm">
            <div class="col-md-12">
                <h4 class="header">SUCCESSFUL PAYMENT</h4>
                ...
                <table data-vertable="ver1">
                  <thead>
                    <tr class="row100 head">
                      ...
                      <th class="column100 column6" data-column="column6">PAYMENT</th>
                      <th class="column100 column7" data-column="column7">RECEIPT</th>
                    </tr>
                  </thead>
                  <?php
                  $counter=1;
                  ...
                  <tbody>
                    <tr class="row100">
                      ...
                      <td class="column100 column2" data-column="column2"><?php echo $row[0];?></td>
                      <td class="column100 column3" data-column="column3"><?php echo $row[2];?></td>
                      ...
                      <td class="column100 column6" data-column="column6"><?php echo $row[5];?></td>
                      <td class="column100 column7" data-column="column7"><form method="post" action="receipt1.php" enctype="multipart/form-data">
                          ...
                          <img alt="" width="30% "src="../images/clip10.png"/>
                      </form></td>
                    </tr>
