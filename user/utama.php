...
$kuiri="SELECT(Select COUNT(STAT_STATUS) FROM stat WHERE STAT_STATUS='Finished' AND STAT_ID='$currentuser'),(Select COUNT(STAT_STATUS) FROM stat WHERE STAT_STATUS='Pending' AND STAT_ID='$currentuser'),(Select COUNT(STAT_STATUS) FROM stat WHERE STAT_STATUS='Printing' AND STAT_ID='$currentuser'),(Select COUNT(STAT_STATUS) FROM stat WHERE STAT_STATUS='Waiting for Payment' AND STAT_ID='$currentuser')";
$kuirirun=mysqli_query($dbconn,$kuiri) or die ("Can Not Continue");
$kuiri1="SELECT(Select SUM(STAT_TOTALCOST) FROM stat WHERE STAT_ID='$currentuser' AND PAYMENT='Successful'),(Select COUNT(STAT_TOTALCOST) FROM stat WHERE STAT_ID='$currentuser' AND PAYMENT='Successful')";
                ...
                <div class="col-md-12">
                    <div class="navbar-collapse collapse ">
                        <ul id="menu-top" class="nav navbar-nav navbar-right">
                          <ul id="menu-top" class="nav navbar-nav navbar-right ">
                            <li><a href="../user/utama.php" class="menu-top-active" >USER HOME</a></li>
