...
<body>
    ...
    if($password!=$confirmpassword)
    {
      ...
      header("Refresh: 0; URL=utama.php");
    }
    else
    {
    mysqli_query($dbconn,"UPDATE user SET USER_FNAME='".$firstname."', USER_LNAME='".$lastname."', USER_CONTACT='".$contactnumber."', USER_EMAIL='".$email."', USER_PASSWORD='".$password."' WHERE USER_NAME='".$currentuser."'");
    if($image)
    {
      $kuiri=mysqli_query($dbconn,"UPDATE user SET USER_IMAGE='".$image."' WHERE USER_NAME='".$currentuser."'");
