...
$currentuser=$_SESSION['USER_NAME'];
  ...
  $kuiri=mysqli_query($dbconn,"DELETE FROM orde WHERE USER_NAME='".$username."' AND ORDE_ID='".$Order_Id."'");
	$kuiri2=mysqli_query($dbconn,"DELETE FROM stat WHERE STAT_ID='".$username."' AND ORDE_ID='".$Order_Id."'");
	echo
